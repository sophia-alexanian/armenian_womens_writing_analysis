...
def filter_male_authors(input_files, output_file, author_gender_column):
    master_data = []
    ...
    for file in input_files:
        try:
            ...
            filtered_data = data[data[author_gender_column].str.lower() == 'male']
